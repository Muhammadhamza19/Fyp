    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
            ...
            <ListItem  disablePadding component={Link} to="addproduct">
              <ListItemButton >
                <ListItemIcon >
                 <InboxIcon />
                </ListItemIcon>
            ...
            <ListItem  disablePadding component={Link} to="addsupplier">
              <ListItemButton >
                <ListItemIcon >
                 <InboxIcon />
                </ListItemIcon>
            ...
            <ListItem  disablePadding component={Link} to="addmanufacture">
              <ListItemButton >
                <ListItemIcon >
                 <InboxIcon />
                </ListItemIcon>
            ...
            <ListItem  disablePadding component={Link} to="adddistributor">
              <ListItemButton >
                <ListItemIcon >
                 <InboxIcon />
                </ListItemIcon>
