    ...
    >
      <Box
        ...
        <FormControl sx={{ marginY: 1, width: "100%" }}>
          ...
          <TextField label="Product ID" variant="outlined" type="text"
            {...register('email', {
        ...
        <FormControl sx={{marginY: 1}} fullWidth>
                    <TextField fullWidth label="Product Name" variant="outlined" type="text" 
        ...
        <FormControl sx={{marginY: 1}} fullWidth>
                    <TextField fullWidth label="Product Category" variant="outlined" type="text" InputProps={{ disableUnderline: true }}
        ...
        <FormControl fullWidth>
                    <TextField fullWidth label="Product Price" variant="outlined" type="number" InputProps={{ disableUnderline: true }}
